...
export class WasmKeyPair {
    ...
    static fromSecretBytes(bytes) {
        ...
        const ret = wasm.wasmkeypair_fromSecretBytes(ptr0, len0);
        if (ret[2]) {
     ...
     */
    toSecretBytes() {
        const ret = wasm.wasmkeypair_toSecretBytes(this.__wbg_ptr);
     ...
     */
    getPublicBytes() {
        const ret = wasm.wasmkeypair_getPublicBytes(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
    ...
    toSecretBase58() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmkeypair_toSecretBase58(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    getPublicBase58() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmkeypair_getPublicBase58(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {WasmKeyPair}
     */
    static fromSecretBase58(s) {
        const ptr0 = passStringToWasm0(s, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmkeypair_fromSecretBase58(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmKeyPair.__wrap(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('nazgul_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
